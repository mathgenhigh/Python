...
class Menu:
    def __init__(self, player, toggle_menu):
        ...
        self.font = pygame.font.Font(r'C:\StardewWalley\font\LycheeSoda.ttf', 30)
    ...
    def setup(self):
        ...
        self.menu_top = SCREEN_H / 2 - self.total_height / 2
        self.main_rect = pygame.Rect(SCREEN_W / 2 - self.width / 2, self.menu_top, self.width, self.total_height)
    ...
    def display_money(self):
        ...
        text_rect = text_surf.get_rect(midbottom = (SCREEN_W / 2, SCREEN_H - 20))
